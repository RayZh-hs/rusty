...
fun ParamsNode.GenericParamsNode.Companion.parse(ctx: ParsingContext): ParamsNode.GenericParamsNode {
    ctx.callMe(name) {
...
fun ParamsNode.FunctionParamsNode.Companion.parse(ctx: ParsingContext): ParamsNode.FunctionParamsNode {
    ctx.callMe(name) {
